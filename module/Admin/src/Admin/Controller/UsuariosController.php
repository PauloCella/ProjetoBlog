...
//            $this->flashMessenger()
//                    ->addErrorMessage('Você precisa logar');
//            return $this->redirect()->toUrl('/');
//        }
        $em = $this->getServiceLocator()->get('Doctrine\ORM\EntityManager');
        $query = $em
                ->createQuery('SELECT Usuario FROM \Admin\Model\Usuario Usuario');
        ...
        if ($request->isPost()) {
            ...
            if ($form->isValid()) {
                ...
                try {
                    ...
                    $this->flashMessenger()->addErrorMessage('Erro ao armazenar usuário :'.$e);
                }
